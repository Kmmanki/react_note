...
var EnhancedButton = LoadWebsite(HiButton);
var EnhancedLink = LoadWebsite(HiLink);
var EnhancedLogo = LoadWebsite(Logo);
var HiOrContent = /*#__PURE__*/function (_React$Component) {
  _inherits(HiOrContent, _React$Component);
  function HiOrContent() {
    _classCallCheck(this, HiOrContent);
    return _callSuper(this, HiOrContent, arguments);
  }
  _createClass(HiOrContent, [{
    key: "render",
...
var el2 = document.getElementById('hi-content');
var root = ReactDOM.createRoot(el2);
root.render( /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(HiOrContent, null, " ")));