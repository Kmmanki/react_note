...
var LoadWebsite = function LoadWebsite(Component) {
  var _LoadWebsite = /*#__PURE__*/function (_React$Component) {
    _inherits(_LoadWebsite, _React$Component);
    function _LoadWebsite(props) {
      var _this;
      _classCallCheck(this, _LoadWebsite);
      _this = _callSuper(this, _LoadWebsite, [props]);
      _this.state = {
        label: 'Run',
        handleClick: _this.handleClick.bind(_assertThisInitialized(_this))
      };
      return _this;
    }
